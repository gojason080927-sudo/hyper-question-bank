...
/** STEP 7 crop-set / corpus-manifest label. Not the SHA256 of ground-truth.json. */
export const STEP7_GROUND_TRUTH_VERSION = 'bfd939311e7d5a6a8f627bc6fb9adaeb28443ae7b3d60898de5c7942acb70fae'
/** SHA256 of workers/ocr/ground-truth.json bytes. Do not confuse with STEP7_GROUND_TRUTH_VERSION. */
