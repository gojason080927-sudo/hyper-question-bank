...
import { GANYEOM2_SPEC, GOJAENG2_SPEC, ILDEUNG2_SPEC, LIGHTSSEN2_SPEC, MOTHER2_SPEC, RPM2_SPEC, TYPELEVEL2_SPEC } from './bookIngestSpec'
...
export const CLASSIFY_TARGETS = [
  ...
  { slug: TYPELEVEL2_SPEC.slug, sourceId: TYPELEVEL2_SPEC.sourceId, title: TYPELEVEL2_SPEC.title },
  { slug: MOTHER2_SPEC.slug, sourceId: MOTHER2_SPEC.sourceId, title: MOTHER2_SPEC.title },
] as const
