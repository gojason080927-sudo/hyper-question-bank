...
STEP 1에서는 위 항목을 테이블로 만들지 않는다. STEP 2.5 FINAL: [QUESTION_DB_MASTER_SCHEMA_v1.md](./QUESTION_DB_MASTER_SCHEMA_v1.md). STEP 3 CORE: [QUESTION_DB_IMPLEMENTATION_v1.md](./QUESTION_DB_IMPLEMENTATION_v1.md). STEP 4 수동 등록/검수: [MANUAL_PROBLEM_WORKFLOW_v1.md](./MANUAL_PROBLEM_WORKFLOW_v1.md).
